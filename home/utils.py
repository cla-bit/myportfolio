""" Utility helpers for sending emails """
...
def send_contact_email(contact):
    ...
    # Email the sender
    template_sender = render_to_string(
        "base/email_sending.html", {"Name": contact.name, "Email": contact.email}
    )
    ...
    template_receiver = render_to_string(
        "base/email_receiving.html",
        {
            "Name": contact.name,
            "Email": contact.email,
